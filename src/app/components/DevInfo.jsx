    ...
    <div className="dev-info">
      ...
      <div className="info-container">
        <div className="info-container-header">
          <h1>{userData.name}</h1>
          <span>{formatJoinDate(userData.created_at)}</span>
        </div>
        ...
        <div className="info-container-links">
          <div className="info-container-first-row">
            <div className="info-first-row-location">
              <svg
                width="14"
                height="20"
                viewBox="0 0 14 20"
            ...
            <div className="info-first-row-twitter">
              <svg
                width="20"
                height="18"
                viewBox="0 0 20 18"
          ...
          <div className="info-container-second-row">
            <div className="info-second-row-website">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <div className="info-second-row-business">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
